 ...
 * @version 1.0
 */
public class AsinFunction extends ScalarUnaryStandardFunction {

	public AsinFunction() {
		name = "arcsin";
		summaryText = "Arcus-Sinus";
	}//Konstruktor 1
	...
	public Object eval(Object[] args) throws MathException {
		return new ScalarDoubleResult(Math
				.asin(((ScalarDoubleResult) args[0]).value));
	} //eval

	/**
	 * Die Ableitung von asin(x) ist 1/sqrt(1-x^2).
	 * 
	 * @param broker
	 * @return 1/sqrt(1-x^2)
	 */
