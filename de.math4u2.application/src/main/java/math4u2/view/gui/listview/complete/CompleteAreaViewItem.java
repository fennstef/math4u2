 ...
 */
public class CompleteAreaViewItem extends AbstractListViewItem {
	...
	public CompleteAreaViewItem(UserFunction model, ListViewInterface parent,
			Broker broker) {
	...
	private MathObject getMathObject() {
		try {
			...
			ExceptionManager.doError("Fehler beim Initialisieren der Flächen-Sicht",e);
