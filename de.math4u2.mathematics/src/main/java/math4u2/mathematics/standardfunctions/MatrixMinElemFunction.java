...
/**
 * Minimum der Elemente einer Matrix
 */

public class MatrixMinElemFunction extends MiscUnaryStandardFunction {

	public MatrixMinElemFunction() {
		name = "minelem";
		summaryText = "Minimum der Elemente einer Matrix oder eines Vektors";
	}//Konstruktor 1
