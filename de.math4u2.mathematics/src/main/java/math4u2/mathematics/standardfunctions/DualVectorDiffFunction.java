...
public class DualVectorDiffFunction extends MatrixDiffFunction {

	public DualVectorDiffFunction() {
		name = "DualVectorDiff";
		operatorName = "-";
		operatorNiceName = " - ";
	}
	...
	public TermNode buildDeriveTerm(TermNode[] arguementTerms,
		...
		try {
			return new TermNodeFunct((Function) (broker
					.getObject("DualVectorDiff")), new TermNode[] {
